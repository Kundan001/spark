...
// MAGIC 
// MAGIC In this notebook, shows you how you read a JSON file, convert your semi-structured JSON data into a collection of Datasets[T], where `T` is a class and introduce some high-level Spark 2.0 Dataset APIs.
